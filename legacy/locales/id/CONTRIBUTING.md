...
### 3. Bergabunglah dengan Komunitas Z Code
...
- Untuk dokumentasi, kunjungi [Dokumentasi Z Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) dengan:
    ...
    - Versi Z Code (wajib); penyedia/model API jika relevan
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi Z Code.
