...
- Để biết tài liệu, hãy truy cập [Tài liệu Z Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) với:
    ...
    - Phiên bản Z Code (bắt buộc); nhà cung cấp/mô hình API nếu có liên quan
...
Bằng cách đóng góp, bạn đồng ý rằng những đóng góp của bạn sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với việc cấp phép của Z Code.
