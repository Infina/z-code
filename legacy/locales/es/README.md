...
Z Code se adapta a tu forma de trabajar, no al revés:
...
- **[Documentación](https://docs.roocode.com):** La guía oficial para instalar, configurar y dominar Z Code.
...
Hay varias formas de ejecutar la extensión Z Code:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión Z Code en ejecución.
