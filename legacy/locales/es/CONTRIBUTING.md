...
### 3. Únase a la comunidad de Z Code
...
- Para la documentación, visite [Documentos de Z Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) con:
    ...
    - Versión de Z Code (obligatorio); proveedor/modelo de API si es relevante
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de Z Code.
