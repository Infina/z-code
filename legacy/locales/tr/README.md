...
## Z Code SİZİN İçin Ne Yapabilir?
...
Z Code, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
- **[Dokümantasyon](https://docs.roocode.com):** Z Code'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
...
Z Code uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, Z Code uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
**Z Code'un keyfini çıkar!** Onu kısa tasmalı tut ya da otonom dolaşsın; ne inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa [Reddit topluluğumuza](https://www.reddit.com/r/RooCode/) ya da [Discord](https://discord.gg/roocode)'a uğra. İyi kodlamalar!
