...
- Belgeler için [Z Code Belgeleri](https://github.com/RooCodeInc/Roo-Code-Docs)ni ziyaret edin.
...
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) kullanarak yeni bir hata oluşturun:
    ...
    - Z Code sürümü (gerekli); ilgiliyse API sağlayıcısı/modeli
...
Katkıda bulunarak, katkılarınızın Z Code'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
