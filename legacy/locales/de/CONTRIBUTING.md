...
### 3. Tritt der Z Code Community bei
...
- Für Dokumentation besuche [Z Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Erstelle einen neuen Fehler mit der [Vorlage „Fehlerbericht“](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) mit:
    ...
    - Z Code-Version (erforderlich); API-Anbieter/Modell, falls relevant
...
Indem du einen Beitrag leistest, stimmst du zu, dass deine Beiträge unter der Apache-2.0-Lizenz lizenziert werden, die mit der Lizenzierung von Z Code übereinstimmt.
