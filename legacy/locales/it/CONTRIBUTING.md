...
### 3. Unisciti alla community di Z Code
...
- Per la documentazione, visita [Z Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) con:
    ...
    - Versione di Z Code (obbligatoria); provider/modello di intelligenza artificiale se pertinente
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di Z Code.
