...
Z Code si adatta al tuo modo di lavorare, non il contrario:
...
- **[Documentazione](https://docs.roocode.com):** La guida ufficiale per installare, configurare e padroneggiare Z Code.
...
Ci sono diversi modi per eseguire l'estensione Z Code:

### Modalità di sviluppo (F5)

Per lo sviluppo attivo, usa il debug integrato di VSCode:

Premi `F5` (o vai su **Esegui** → **Avvia debug**) in VSCode. Si aprirà una nuova finestra di VSCode con l'estensione Z Code in esecuzione.
