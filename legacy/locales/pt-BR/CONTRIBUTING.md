...
### 3. Junte-se à comunidade Z Code
...
- Para documentação, visite [Documentação do Z Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) com:
    ...
    - Versão do Z Code (obrigatório); provedor/modelo de IA, se relevante
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Z Code.
