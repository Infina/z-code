...
### 3. Присоединяйтесь к сообществу Z Code
...
- Для документации посетите [Документацию Z Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) с:
    ...
    - Версией Z Code (обязательно); поставщиком/моделью ИИ, если применимо
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Z Code.
