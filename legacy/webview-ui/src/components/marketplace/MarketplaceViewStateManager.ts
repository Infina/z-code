 ...
 *
 * This class manages the state for the marketplace view in the Z Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Z Code extensions interface
