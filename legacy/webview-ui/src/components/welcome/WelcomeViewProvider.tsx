...
const WelcomeViewProvider = () => {
	...
	const handleGetStarted = useCallback(() => {
		// Landing screen - navigate to provider selection instead of forced auth
									...
									<div className="w-full max-w-sm">
										...
										<div className="flex gap-2 items-center">
											<VSCodeTextField
												...
												placeholder="vscode://RooVeterinaryInc.z-code/auth/clerk/callback?state=..."
												className="flex-1"
											/>
											<Button
										...
										<p className="mt-2">
											<Trans
												...
												components={{
													DocsLink: (
														<a
															href={buildDocLink("z-code-cloud/login", "setup")}
															target="_blank"
				...
				<TabContent className="flex flex-col gap-4 p-6 justify-center">
					...
					<div className="mt-2 flex flex-col gap-3">
						...
						<div className="text-xs opacity-50">
							<VSCodeLink onClick={() => setSelectedProvider("custom")} className="cursor-pointer">
								Skip login and use custom API
							</VSCodeLink>
						</div>
					</div>
				</TabContent>
