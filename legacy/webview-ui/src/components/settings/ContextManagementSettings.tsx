	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						checked={repoMapEnabled}
						onChange={(e: any) => setCachedStateField("repoMapEnabled", e.target.checked)}
						data-testid="repo-map-enabled-checkbox">
						<label className="block font-medium mb-1">
							Enable Holographic Repo Map (Rust)
						</label>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1 mb-3">
						Uses a high-fidelity graph algorithm to identify the most relevant code context based on your focus.
						Access the map via the database icon in the chat input.
					</div>
				</div>
