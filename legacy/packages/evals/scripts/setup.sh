...
build_extension() {
  echo "🔨 Building the Z Code extension..."
...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "The Z Code evals system can also be run with Docker on any platform."
...
echo -n "🗄️ Syncing Z Code evals database... "
...
read -p "💻 Do you want to build a new version of the Z Code extension? [currently $current_version] (y/N): " build_extension
