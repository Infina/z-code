...
export const globalSettingsSchema = z.object({
	...
	repoMapEnabled: z.boolean().optional(),
	...
	terminalZdotdir: z.string().optional(),
	...
	telemetrySetting: z.enum(["unset", "enabled", "disabled"]).optional(),
	mode: z.string().optional(),
	customModePrompts: z.record(z.string(), z.any()).optional(),
	customSupportPrompts: z.record(z.string(), z.any()).optional(),
	codebaseIndexConfig: z.any().optional(),
	codebaseIndexModels: z.any().optional(),
	cachedChromeHostUrl: z.string().optional(),
	mcpEnabled: z.boolean().optional(),
	profileThresholds: z.record(z.string(), z.number()).optional(),
	includeTaskHistoryInEnhance: z.boolean().optional(),
	enterBehavior: z.string().optional(),
	enableCheckpoints: z.boolean().optional(),
	remoteBrowserHost: z.string().optional(),
	modeApiConfigs: z.record(z.string(), z.string()).optional(),
	enhancementApiConfigId: z.string().optional(),
	reasoningBlockCollapsed: z.boolean().optional(),
	customModes: z.array(z.any()).optional(),
