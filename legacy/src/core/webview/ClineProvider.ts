	...
	implements vscode.WebviewViewProvider, TelemetryPropertiesProvider, TaskProviderLike
{
	...
	constructor(
		...
		// Initialize Z Code Cloud profile sync.
	...
	*/
	...
	async ensureMcpServersDirectoryExists(): Promise<string> {
		...
		try {
			...
			return path.join(os.homedir(), ".z-code", "mcp")
		}
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		return {
			...
			terminalZdotdir: terminalZdotdir ? String(terminalZdotdir) : undefined,
	...
	> {
		...
		return {
			...
			terminalZdotdir: stateValues.terminalZdotdir ? String(stateValues.terminalZdotdir) : undefined,
