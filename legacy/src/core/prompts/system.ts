...
async function generatePrompt(
	...
	let holographicMap = ""
	try {
		const repoMapService = RepoMapService.getInstance(context)
		// Get currently open files to use as focus
		...
		holographicMap = repoMapService.getOptimisticMap(cwd, openFiles)
	} catch (e) {
		console.error("Failed to get holographic map from cache:", e)
	}
