...
export class GeminiEmbedder implements IEmbedder {
	...
	private static readonly GEMINI_EMBEDDINGS_URL = "https://generativelanguage.googleapis.com/v1beta/openai/embeddings"
	...
	constructor(apiKey: string, modelId?: string) {
		...
		// We use the full /embeddings URL so the OpenAICompatibleEmbedder will
		// use a direct fetch request and can send Google-specific auth headers.
		this.openAICompatibleEmbedder = new OpenAICompatibleEmbedder(
			GeminiEmbedder.GEMINI_EMBEDDINGS_URL,
			apiKey,
			this.modelId,
