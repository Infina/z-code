...
describe("QdrantVectorStore", () => {
	...
	describe("URL Parsing and Explicit Port Handling", () => {
		...
		describe("Common user input mistakes", () => {
			it("should normalize URLs that include the /collections endpoint", () => {
				const vectorStore = new QdrantVectorStore(
					mockWorkspacePath,
			...
			it("should normalize URLs that include the /collections/ endpoint with trailing slash", () => {
				const vectorStore = new QdrantVectorStore(
					mockWorkspacePath,
					"http://localhost:6333/collections/",
					mockVectorSize,
