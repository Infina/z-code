...
- Feat: Enable mergeToolResultText for Z Code Cloud provider (PR #10301 by @hannesrudolph)
...
- UX improvements to the Z Code Cloud provider-centric onboarding flow (PR #9709 by @brunobergher)
...
- Revert "Add support for Z Code Cloud as an embeddings provider" while we fix some issues (PR #9602 by @mrubens)

## [3.34.4] - 2025-11-25

![3.34.4 Release - BFL Image Generation](/releases/3.34.4-release.png)

- Add new Black Forest Labs image generation models, free on Z Code Cloud and also available on OpenRouter (PR #9587 and #9589 by @mrubens)
...
- Add support for Z Code Cloud as an embeddings provider (PR #9543 by @mrubens)
- Fix ask_followup_question streaming issue and add missing tool cases (PR #9561 by @daniel-lxs)
- Add contact links to About Z Code settings page (PR #9570 by @roomote)
...
- Add Z Code Cloud as an image generation provider (PR #9528 by @mrubens)
...
- Enable the Z Code Cloud provider in evals (PR #9492 by @cte)
...
- Z Code Cloud Provider pricing page and changes elsewhere (PR #9195 by @brunobergher)
...
- Fix: Z Code Cloud provider Anthropic input token normalization to avoid double-counting (thanks @hannesrudolph!)
...
- Add dynamic model loading for Z Code Cloud provider (thanks @app/roomote!)
...
- New code-supernova stealth model in the Z Code Cloud provider (thanks @mrubens!)
...
- Announce Z Code Cloud!
- Add cloud task button for opening tasks in Z Code Cloud (thanks @app/roomote!)
...
![3.28.0 Release - Continue tasks in Z Code Cloud](/releases/3.28.0-release.png)

- feat: Continue tasks in Z Code Cloud (thanks @brunobergher!)
...
- Feature: Add DeepInfra as a model provider in Z Code (#7661 by @Thachnh, PR by @Thachnh)
...
- Fix issue where new users couldn't select the Z Code Cloud provider (thanks @daniel-lxs!)

## [3.25.18] - 2025-08-19

- Add new stealth Sonic model through the Z Code Cloud provider
...
- Add Z Code Cloud Waitlist CTAs (thanks @brunobergher!)
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the Z Code settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause Z Code to hang, particularly in orchestrator mode
...
- Simplify and streamline Z Code's quick actions
- Allow Z Code settings to be imported from the welcome screen (thanks @julionav)
...
- Focus Z Code in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus Z Code input field (thanks @axkirillov!)
...
- Allow processes to access the Z Code API via a unix socket
...
- Add an activation command that other extensions can use to interface with Z Code (thanks @gtaylor!)
...
- Internationalize Z Code into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Add opt-in telemetry to help us improve Z Code faster (thanks Cline!)
...
- Add support for a .rooignore to prevent Z Code from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Z Code (thanks @NyxJae)!
...
- Introducing Z Code 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New Z Code community Discord at https://roocode.com/discord!
...
- **Name Change From Roo Cline to Z Code:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to Z Code to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for Z Code! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
- This release adds chat modes! Now you can ask Z Code questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Z Code Reddit! https://www.reddit.com/r/RooCode
